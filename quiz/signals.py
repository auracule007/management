...
from .models import *
from api.models import ModulesHighFive, PointForEachModule, GemForEachPoint, Coin, Token, UserPerformance
...
# @receiver(post_save, sender=AssignmentSubmission)
# def create_all_rewards(sender, instance, created, **kwargs):
#     try:
